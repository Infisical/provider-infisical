...
// GetItems of this AccessApprovalPolicyList.
func (l *AccessApprovalPolicyList) GetItems() []resource.Managed {
...
// GetItems of this ProjectTemplateList.
func (l *ProjectTemplateList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
