...
// ResolveReferences of this AccessApprovalPolicy.
func (mg *AccessApprovalPolicy) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this ProjectGroup.
func (mg *ProjectGroup) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this ProjectUser.
func (mg *ProjectUser) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
